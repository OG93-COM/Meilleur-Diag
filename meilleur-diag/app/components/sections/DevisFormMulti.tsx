...
import {
  ...
  User, Mail, Phone, MapPin, CheckCircle2, Loader2
} from 'lucide-react'
...
// sub-steps inside "step 0"
// subStep: 0=pack 1=typeBien 2=annee 3=surface+gaz
// main step: 0=bien, 1=coordonnées, 2=confirmation

export default function DevisFormMulti() {
  const [step, setStep]       = useState(0)    // 0=bien, 1=coords, 2=confirm
  const [sub,  setSub]        = useState(0)    // 0..3 inside step 0
  ...
  // progress: step 0 = sub/4 * 0.33, step1 = 0.33..0.66, step2 = 0.66..1
  const progress = step === 0 ? (sub / 4) * 33
                 : step === 1 ? 33 + 33
                 : 99
    ...
    <button
      ...
      className={`relative flex items-center justify-between w-full px-5 py-4 rounded-2xl border-2 text-sm font-semibold transition-all duration-150 cursor-pointer text-left
        ${active
          ...
          : 'border-[#ebebeb] bg-white text-mygray hover:border-primary/40'
        }`}
    ...
    <section className="py-20 bg-[#f8f8f8]" id="devis">
      <div className="container-custom">
        <div className="max-w-xl mx-auto">
          ...
          {/* Progress bar */}
          <div className="h-1.5 bg-[#ebebeb] rounded-full mb-8 overflow-hidden">
            <div
            ...
            {step === 0 && sub === 1 && (
              <div className="p-7 md:p-9">
                ...
                <div className="space-y-3">
                  {typesBien.map(t => (
                    <PillBtn
                      key={t} label={t} active={form.typeBien === t}
            ...
            {step === 0 && sub === 2 && (
              <div className="p-7 md:p-9">
                ...
                <div className="space-y-3">
                  {annees.map(a => (
                    <PillBtn
                      key={a} label={a} active={form.anneeConstruction === a}
