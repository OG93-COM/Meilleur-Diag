...
const quickLinks = [
  ...
  { label: 'Pourquoi Meilleur Diag ?', href: '/a-propos' },
        ...
        <div className="container-custom py-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-3 flex-shrink-0">
              ...
              <Link href="/devis" className="flex items-center gap-2 bg-white text-black font-semibold px-5 py-3 rounded-lg hover:bg-white/90 transition-colors text-sm">
                Devis Gratuit
                <ArrowRight size={16} />
              </Link>
            </div>
